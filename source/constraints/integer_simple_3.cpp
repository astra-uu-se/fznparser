...
std::pair<Int, Int> IntDiv::calculateDomain([[maybe_unused]] Variable* _) {
  std::vector<Int> exs;
...
std::pair<Int, Int> IntMax::calculateDomain([[maybe_unused]] Variable* _) {
...
std::pair<Int, Int> IntMin::calculateDomain([[maybe_unused]] Variable* _) {
...
std::pair<Int, Int> IntMod::calculateDomain([[maybe_unused]] Variable* _) {
  Int lb = std::max(_variables[0]->lowerBound(), _variables[1]->lowerBound());
  Int ub = std::min(_variables[0]->upperBound(), _variables[1]->upperBound());
  return std::make_pair(lb, ub);
}
std::pair<Int, Int> IntPow::calculateDomain([[maybe_unused]] Variable* _) {
...
std::pair<Int, Int> IntTimes::calculateDomain([[maybe_unused]] Variable* _) {
  std::vector<Int> exs;
